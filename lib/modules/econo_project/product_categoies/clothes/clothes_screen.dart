...
import 'clothes_cubit/clothes_cubit.dart';
import 'clothes_cubit/clothes_states.dart';
class ClothesScreen extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<ClothesCubit, ClothesStates>(
      listener: (context, state) {},
      builder: (context, state) {
        var prodcatcubit = ClothesCubit
            .get(context)
            .procatmodel;
