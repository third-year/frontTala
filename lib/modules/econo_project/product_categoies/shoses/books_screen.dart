...
import 'package:firstflutterproject/modules/econo_project/product_categoies/shoses/shose_cubit/shose_cubit.dart';
...
class ShoseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ShoseCubite, ShoseStates>(
      listener: (context, state) {},
      builder: (context, state) {
        var prodcatcubit = ShoseCubite
            .get(context)
            .procatmodel;
