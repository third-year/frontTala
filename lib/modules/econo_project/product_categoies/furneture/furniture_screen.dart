...
import 'furniture_cubit/furniture_cubit.dart';
import 'furniture_cubit/furniture_states.dart';

class FurnitureScreen extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<FurnitureCubite, FurnitureStates>(
      listener: (context, state) {},
      builder: (context, state) {
        var prodcatcubit = FurnitureCubite
            .get(context)
            .procatmodel;
