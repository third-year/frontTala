...
import 'package:firstflutterproject/modules/econo_project/product_categoies/technology/technology_cubit/technology_cubit.dart';
import 'package:firstflutterproject/modules/econo_project/product_categoies/technology/technology_cubit/technology_states.dart';
...
class TechnologyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<TechnologyCubite, TechnologyStates>(
      listener: (context, state) {},
      builder: (context, state) {
        var prodcatcubit = TechnologyCubite
            .get(context)
            .procatmodel;
